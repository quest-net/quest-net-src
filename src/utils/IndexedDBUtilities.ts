...
export class IndexedDBUtilities {
   ...
   */
  static async save(id: string, data: Blob | ArrayBuffer, metadata?: Record<string, any>): Promise<void> {
   ...
   */
  static async load(id: string): Promise<{ data: Blob | ArrayBuffer; metadata: Record<string, any> } | null> {
    const db = await this.initDB();
