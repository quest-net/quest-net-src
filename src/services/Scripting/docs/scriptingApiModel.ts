...
export const FACADE_DOCS: FacadeGroupDoc[] = [
	...
	},
	{
		...
		methods: [
			...
			{ signature: 'await game.toast("Hero", "text", opts?)', description: "Private toast/whisper to ONE player's character (name|id) — only they (and the DM) see it, in the log and as an alert. opts: { category?, level?, details? }.", backedBy: "log:create" },
	...
	},
	{
		...
		methods: [
			...
			{ signature: 'actor.toast("text", opts?)', description: "Private toast/whisper to THIS actor's player — only they (and the DM) see it. opts: { category?, level?, details? }.", backedBy: "log:create" },
