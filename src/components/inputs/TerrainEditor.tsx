  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            disabled={isReadOnly}
          />
          <span className="text-xs tabular-nums w-6 text-center">{brushSize}</span>
        </div>
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <div className="join">
          <button className="btn btn-sm join-item btn-disabled">Random Hills</button>
          <button className="btn btn-sm join-item btn-disabled">Random Trees</button>
          <button className="btn btn-sm join-item btn-disabled">Random Islands</button>
          <button className="btn btn-sm join-item btn-disabled">Random Valley</button>
          <button className="btn btn-sm join-item btn-disabled">Reset (Flatten)</button>
        </div>
      </div>
