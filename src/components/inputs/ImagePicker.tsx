...
export function ImagePicker({ value, onChange, readOnly, label = "Image" }: ImagePickerProps) {
                  ...
                  {filteredImages.map(image => (
                    ...
                    >
                      ...
                      <div className="card-body p-2">
                        <h4 className="text-xs font-semibold truncate" title={image.Name}>
                          {image.Name}
                        </h4>
                        <div className="text-xs opacity-60">
                          <div>{formatFileSize(image.FileSize)}</div>
                          <div className="font-mono">{image.Width}×{image.Height}</div>
                        </div>
                        {selectedImageId === image.Id && (
