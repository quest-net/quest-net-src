...
import { ImpersonationPicker } from "../../components/pickers/ImpersonationPicker";
...
const menuItems: { id: TabView; label: string; icon: string }[] = [
	...
	{ id: "items", label: "Items", icon: "icon-[mdi--sack]" },
	{ id: "skills", label: "Skills", icon: "icon-[mdi--star]" },
